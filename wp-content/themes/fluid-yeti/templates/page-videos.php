	...
	<div class="row">
		<?php if(have_rows('videos_repeater')) : ?>
			...
			<?php while(have_rows('videos_repeater')) : the_row(); ?>
				<div class="medium-4 columns videos">
					<a href="#" data-reveal-id="vidModal-<?php echo $count ?>">
						<img src="<?php echo esc_url(home_url()); ?>/wp-content/themes/fluid-yeti/assets/img/play-standard.png" class="video-play">
						<img src="http://img.youtube.com/vi/<?php the_sub_field('video_id') ?>/0.jpg" alt="">
					</a>
					<h3><?php the_sub_field('video_title') ?></h3>
					<p><?php the_sub_field('video_description') ?></p>

					<div id="vidModal-<?php echo $count ?>" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">
					  <div class="flex-video">
					  	<iframe src="https://www.youtube.com/embed/<?php the_sub_field('video_id') ?>" frameborder="0" allowfullscreen></iframe>
					  </div>
